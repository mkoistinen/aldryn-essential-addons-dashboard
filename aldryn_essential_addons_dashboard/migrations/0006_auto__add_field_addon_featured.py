...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Addon.featured'
        db.add_column(u'aldryn_essential_addons_dashboard_addon', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Addon.featured'
        db.delete_column(u'aldryn_essential_addons_dashboard_addon', 'featured')
