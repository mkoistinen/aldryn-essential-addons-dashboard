...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Addon.last_webhook_timestamp'
        db.add_column(u'aldryn_essential_addons_dashboard_addon', 'last_webhook_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Addon.last_webhook_timestamp'
        db.delete_column(u'aldryn_essential_addons_dashboard_addon', 'last_webhook_timestamp')
